...
describe('calculator methods', () => {
    ...
    //expect(calc.sum(1, 3)).toMatchSnapshot();
    });

    test('subtract 1 - 2 to equal -1', () => {
        expect(calc.subtract(1, 2)).toBe(-1);
        //expect(calc.subtract(2, 2)).toMatchSnapshot();
    });


    test('multiply 7 * 7 to equal 49', () => {
        expect(calc.multiply(7, 7)).toBe(49);
        //expect(calc.multiply(7, 7)).toMatchSnapshot();
    });

    test('divide 49 / 7 to equal 7', () => {
        expect(calc.divide(49, 7)).toBe(7);
        //expect(calc.divide(49, 7)).toMatchSnapshot();
    });
